        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              <div
                className="hero-content wow fadeInUp mx-auto max-w-[1100px] text-center"
                data-wow-delay=".2s"
              >
                                <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                  Translate research questions into scalable, sandboxed workflows across HPC or cloud.
                </h1>
                <p className="mb-8 text-base text-white/80 sm:text-lg md:text-xl">
                  Turn natural queries into powerful parallel processing pipelines. Scale biological data analysis—no coding required.
                </p>
                <p className="mb-8 text-sm text-white/70 sm:text-base">
                  Piloting with research labs and genome facilities
                </p>
                <div className="flex justify-center">
                  <Link
                    href="https://www.demo.com"
                    target="_blank"
                    className="inline-flex items-center justify-center gap-2 rounded-lg bg-sky-500 px-8 py-4 text-base font-semibold text-white transition duration-300 ease-in-out hover:bg-sky-600 sm:px-10 sm:py-5 sm:text-lg"
                  >
                    Try Demo
                    <svg 
                      className="h-5 w-5" 
